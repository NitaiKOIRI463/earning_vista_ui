                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0 me-3">
                                            <img src="<?php echo base_url(); ?>assets/images/users/avatar-1.jpg" alt="" class="avatar-md rounded-circle img-thumbnail">
                                        </div>
                                        <div class="flex-grow-1 align-self-center">
                                            <div class="text-muted">
                                                <p class="mb-2">Welcome to Earn Vista Dashboard</p>
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <div>
                                                    ...
                                                    <p class="text-muted text-truncate mb-2"><?php echo $email; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div>
                                                    <h5 class="mb-0">Member Id</h5>
                                                    <p class="text-muted text-truncate mb-2"><?php echo $member; ?></p>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h4 class="mb-0"><?php echo $R; ?><span>$</span></h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h4 class="mb-0"><?php echo $I; ?> <span>$</span></h4>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h4 class="mb-0"><?php echo $M; ?> <span>$</span></h4>
                                        </div>

                                        <div class="flex-shrink-0 align-self-center">
                                            <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                                                <span class="avatar-title rounded-circle bg-primary">
                                                    <i class="fas fa-bacon font-size-24"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-shrink-0 align-self-center">
                                            <div class="avatar-sm rounded-circle bg-primary mini-stat-icon">
                                                <span class="avatar-title rounded-circle bg-primary">
                                                    <i class="fas fa-object-ungroup font-size-24"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <h4 class="mb-0"><?php echo $W; ?> <span>$</span></h4>
                                        </div>
