                        ...
                        <div class="card-body pt-0">
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <h5 class="font-size-13 text-truncate"><?php echo $_SESSION['name']; ?></h5>
                                    <p class="text-muted mb-0 text-truncate">8210648399</p>
                                </div>
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <p class="text-muted mb-0">simaronkumari@gmail.com</p>
                                            </div>
                                            <div class="col-12">
                                                <h5 class="font-size-15">Member Id</h5>
                                                <p class="text-muted mb-0">EV1002</p>
                                            </div>
                                            <div class="col-12">
                                                <h5 class="font-size-15">Plan</h5>
